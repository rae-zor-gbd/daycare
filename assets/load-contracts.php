...
if ($result_contracts->num_rows>0) {
  while ($row_contracts=$result_contracts->fetch_assoc()) {
    ...
    <div class='panel-heading dog-heading'><strong>$lastName</strong>, $dogName<button type='button' class='button-complete' id='complete-contract-button' data-id='$dogID' title='Mark Daycare Contract as Completed'></button></div>
    </div>";
  }
}
?>
