...
if (isset($_POST['vetID']) AND $_POST['vetID']!='') {
  ...
  while ($row_requests=$result_requests->fetch_assoc()) {
    ...
    echo "<strong>Notes for $dogName: </strong>" . stripslashes($dogNotes) . "</div>
    </div>";
  }
}
?>
