...
if (isset($_POST['id']) AND isset($_POST['dogName']) AND isset($_POST['clientRegistration']) AND isset($_POST['daycareContract']) AND isset($_POST['reserveMondays']) AND isset($_POST['reserveTuesdays']) AND isset($_POST['reserveWednesdays']) AND isset($_POST['reserveThursdays']) AND isset($_POST['reserveFridays']) AND isset($_POST['assessmentDayReportCard']) AND isset($_POST['firstDayReportCard']) AND isset($_POST['secondDayReportCard']) AND isset($_POST['thirdDayReportCard'])) {
  ...
  $sql_add_dog="INSERT INTO dogs (dogName, ownerID, clientRegistration, daycareContract, reserveMondays, reserveTuesdays, reserveWednesdays, reserveThursdays, reserveFridays, assessmentDayReportCard, firstDayReportCard, secondDayReportCard, thirdDayReportCard) VALUES ('$dogName', '$ownerID', '$clientRegistration', '$daycareContract', '$reserveMondays', '$reserveTuesdays', '$reserveWednesdays', '$reserveThursdays', '$reserveFridays', '$assessmentDayReportCard', '$firstDayReportCard', '$secondDayReportCard', '$thirdDayReportCard')";
